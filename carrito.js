document.addEventListener("DOMContentLoaded", () => {
  ...
  function actualizarCarritoUI() {
    ...
    const botonesSumarCarrito = carritoItemsContainer.querySelectorAll(
      ".cantidad-btn.sumar-carrito"
    );
    const botonesRestarCarrito = carritoItemsContainer.querySelectorAll(
      ".cantidad-btn.restar-carrito"
    );
    const botonesEliminarItem =
      carritoItemsContainer.querySelectorAll(".eliminar-item");
